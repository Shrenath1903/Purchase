		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mrpletendertenderdocument-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletendertenderdocument-display": {
								"semanticObject": "mrpletendertenderdocument",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.tenderdocument",
									"url": sap.ui.require.toUrl("mrpl/etender/tenderdocument")
								}
							}
						}
					}
