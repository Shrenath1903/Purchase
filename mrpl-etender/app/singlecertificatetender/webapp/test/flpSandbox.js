		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Single Certificate Tender",
									"targetURL": "#mrpletendersinglecertificatetender-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletendersinglecertificatetender-display": {
								"semanticObject": "mrpletendersinglecertificatetender",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.singlecertificatetender",
									"url": sap.ui.require.toUrl("mrpl/etender/singlecertificatetender")
								}
							}
						}
					}
