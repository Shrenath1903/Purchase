		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Purchase Req Released",
									"targetURL": "#mrplmmreleasedprspurchasereq-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrplmmreleasedprspurchasereq-display": {
								"semanticObject": "mrplmmreleasedprspurchasereq",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.mm.releasedprs.purchasereq",
									"url": sap.ui.require.toUrl("mrpl/mm/releasedprs/purchasereq")
								}
							}
						}
					}
