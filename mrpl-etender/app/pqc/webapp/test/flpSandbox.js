		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PQC FORM",
									"targetURL": "#mrpletenderpqc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletenderpqc-display": {
								"semanticObject": "mrpletenderpqc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.pqc",
									"url": sap.ui.require.toUrl("mrpl/etender/pqc")
								}
							}
						}
					}
