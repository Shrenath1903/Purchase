		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Negotiation Form",
									"targetURL": "#mrpletendernegotiationform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletendernegotiationform-display": {
								"semanticObject": "mrpletendernegotiationform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.negotiationform",
									"url": sap.ui.require.toUrl("mrpl/etender/negotiationform")
								}
							}
						}
					}
