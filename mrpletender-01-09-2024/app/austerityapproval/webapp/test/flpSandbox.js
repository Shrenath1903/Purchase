		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Austerity Approval",
									"targetURL": "#mrpletenderausterityapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletenderausterityapproval-display": {
								"semanticObject": "mrpletenderausterityapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.austerityapproval",
									"url": sap.ui.require.toUrl("mrpl/etender/austerityapproval")
								}
							}
						}
					}
