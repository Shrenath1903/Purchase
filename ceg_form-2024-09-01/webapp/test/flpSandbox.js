		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mrpletendercegform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletendercegform-display": {
								"semanticObject": "mrpletendercegform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.cegform",
									"url": sap.ui.require.toUrl("mrpl/etender/cegform")
								}
							}
						}
					}
