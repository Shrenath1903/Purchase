		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#emddetailsform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"emddetailsform-display": {
								"semanticObject": "emddetailsform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=emddetailsform",
									"url": sap.ui.require.toUrl("emddetailsform")
								}
							}
						}
					}
