		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CEG FORM",
									"targetURL": "#mrpletenderceg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletenderceg-display": {
								"semanticObject": "mrpletenderceg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.ceg",
									"url": sap.ui.require.toUrl("mrpl/etender/ceg")
								}
							}
						}
					}
