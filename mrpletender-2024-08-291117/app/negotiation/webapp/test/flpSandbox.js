		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Negotiation",
									"targetURL": "#mrpletendernegotiation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletendernegotiation-display": {
								"semanticObject": "mrpletendernegotiation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.negotiation",
									"url": sap.ui.require.toUrl("mrpl/etender/negotiation")
								}
							}
						}
					}
