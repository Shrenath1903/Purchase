		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#mrpletenderbidevaluation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrpletenderbidevaluation-display": {
								"semanticObject": "mrpletenderbidevaluation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mrpl.etender.bidevaluation",
									"url": sap.ui.require.toUrl("mrpl/etender/bidevaluation")
								}
							}
						}
					}
